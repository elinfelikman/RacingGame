...
## 🎮 Game Description
In this game, the player controls a **[car]** navigating through obstacles. The objective is to survive as long as possible by switching between lanes to avoid oncoming **[rocks]**.
